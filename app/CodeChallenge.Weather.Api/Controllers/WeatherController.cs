namespace CodeChallenge.Weather.Api.Controllers
{
    ...
    public class WeatherController : ControllerBase
    {
        ...
        /// <summary>
        /// Get the information about the city if is having a good o bad weather, when is bad weather also includes the sensor(s)
        ...
        /// <summary>
        /// Create a new petition to get from OpenWeather API the last status of the weather for the city 
        /// </summary>
        /// <remarks>
        /// Sample request:
        ///
